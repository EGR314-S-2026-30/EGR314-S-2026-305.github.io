...
From our research, we found that a good exploration device needs to be realistic but still easy to understand and operate. Users should always know what the rover is doing and how their actions affect it. Clear feedback—both visual and auditory—helps make the system intuitive, especially since operators can’t directly touch the rover or see everything it’s sensing. We also learned that durability and safety are really important. The rover has to handle repeated use, bumps, and mistakes without breaking. Its moving parts should be protected, motors should be limited to safe forces, and the controls should default to safe states if something goes wrong. These are similar to the real challenges engineers face with planetary rovers. Finally, research showed that too many controls or hidden functions can confuse users. Keeping interactions simple, sequential, and supported with clear cues makes it easier to understand cause-and-effect and complete tasks successfully. Generating a lot of ideas before deciding what to include also helped us explore creative ways to meet these needs. This approach guided our brainstorming and shaped the design of our rover.  

## Goal of the Exploration Device
The goal of this exploration device is to simulate a realistic robotic exploration rover equipped with a robotic sampling arm, representative of systems used in NASA planetary and remote-environment missions. The rover is designed to demonstrate how engineers remotely navigate, sense, manipulate, and collect samples in environments where direct human presence is impossible. The device emphasizes system-level thinking, sensor–actuator integration, and operational decision-making under constraints. Rather than focusing on entertainment or basic instruction, the rover is intended to showcase engineering design considerations such as mobility tradeoffs, arm kinematics, sensing limitations, communication latency, and fault handling. Users interact with the rover as operators and analysts, reinforcing the relationship between system design choices and mission outcomes.
